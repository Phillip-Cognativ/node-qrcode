 ...
 */
export function toFileStream(stream: /* stream.Writable */ any, text: string | QRCodeSegment[], callback: (error: Error) => void): void;
/**
 * Writes QR Code image to stream. Only works with png format for now.
 */
export function toFileStream(stream: /* stream.Writable */ any, text: string | QRCodeSegment[], options?: QRCodeToFileStreamOptions): Promise<any>;
/**
 * Writes QR Code image to stream. Only works with png format for now.
 */
export function toFileStream(stream: /* stream.Writable */ any, text: string | QRCodeSegment[], options: QRCodeToFileStreamOptions, callback: (error: Error) => void): void;
